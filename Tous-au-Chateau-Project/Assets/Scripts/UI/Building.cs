using System.Collections; using System.Collections.Generic; using UnityEngine;  public enum BuildingType { Basics, DirectionalPanel };  public class Building : MonoBehaviour {      public string _name;     public BuildingType buildingType;     public GameObject prefab;
    public GameObject prefabTransparent;     public AudioSource purchasedSound;      [SerializeField]     protected ResourcesPack _cost;          private float _width;     private float _height;     private bool _isDraggable;      private bool _hasLanded;      public virtual void Crush()     {         // if(this.gameObject.CompareTag("crushable"))         //apply function VR      }      public bool CanBuy()     {         bool hasEnoughResources = ResourceManager.Instance.RemoveResources(_cost);          if (!hasEnoughResources)
        {
